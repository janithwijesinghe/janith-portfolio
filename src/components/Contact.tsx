...
export default function Contact() {
  ...
  // Initialize EmailJS
  useEffect(() => {
    emailjs.init("O9ubO3JIr-WR1wwjw");
              ...
              {!submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-[#0a0a0f] border border-gray-700 rounded-xl"
                  />
                  ...
                  <button
                    type="submit"
                    className="w-full px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-xl font-semibold text-lg flex items-center justify-center gap-2"
                  >
